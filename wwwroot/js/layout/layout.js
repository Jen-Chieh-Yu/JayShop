...
const navbar = createApp({
    data() {
        return {
            ...
            navLinks: [
                ...
                { type: "1", hrefName: "日本商品" },
                { type: "2", hrefName: "韓國商品" },
            ],
            searchValue: null,
            trackCount: 0,
            menuOpened: false
    ...
    methods: {
        ...
        searchBtn() {
            if (this.searchValue) {
                const url = "/Search/Search?keyword=" + `${this.searchValue}`;       
...
const footer = createApp({
            ...
            footerList: [
                ...
                },
                {
                    ...
                    footerItems: [
                        ...
                        {
                            icon: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-line" viewBox="0 0 16 16">
    ...
    created() {
        ...
        this.currentTime = currentTime + " | Jay's Shop All Rights Reserved. | 關於Jay's Shop";
    },
    mounted() {
    }
});
